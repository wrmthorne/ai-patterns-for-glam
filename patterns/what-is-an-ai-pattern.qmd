...
A pattern is a reusable solution to a commonly occurring problem. The concept comes from architecture — Christopher Alexander's work on design patterns — and was later adopted by software engineering. In this book, we apply the same idea to AI implementations for information professionals: librarians, archivists, journalists, and anyone working with large collections of documents or data.
