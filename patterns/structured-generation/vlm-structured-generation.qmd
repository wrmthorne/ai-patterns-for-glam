...
def query_image(image: str | PILImage, prompt: str, model: str='qwen3-vl-2b-instruct-mlx', max_image_size: int=1024, client=hf_client) -> str:
...
image.save(buffered, format="JPEG")
image_base64 = base64.b64encode(buffered.getvalue()).decode('utf-8')
completion = hf_client.beta.chat.completions.parse(
    model="Qwen/Qwen3-VL-8B-Instruct",
    messages=[
         {
            "role": "user",
