...
We'll use the [DOAB Metadata Extraction](https://huggingface.co/datasets/biglam/doab-metadata-extraction) dataset from Hugging Face. This contains page images and ground truth metadata for 9,363 open access academic books from the Directory of Open Access Books.
...
1. **Assemble a ground truth dataset** — even 50 manually verified examples gives you useful signal. Publish it on Hugging Face so others can reproduce your results.
